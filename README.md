...
|2013|**SJTU HDR**|4K|10|8|15|[Link](http://medialab.sjtu.edu.cn/web4k/index.html)|A set of 15 4K resolution ultra-high definition (UHD) video sequences, the shot and post-processing team are from Shanghai Jiao Tong University (SJTU) and National Engineering Research Center of Digital Television (NERC-DTV). All of the UHD video sequences were shot using Sony F65 camera, and the frame rate is 30 fps.|
